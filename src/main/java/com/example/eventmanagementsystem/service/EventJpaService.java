...
public class EventJpaService implements EventRepository {
    ...
    @Autowired
    private EventJpaRepository ejr;

    @Override
    public ArrayList<Event> getEvents() {
        List<Event> eventList = ejr.findAll();
    ...
    public Event getEventById(int eventId) {
        try {
            Event event = ejr.findById(eventId).get();
            return event;
        } catch (Exception e) {
    ...
    public Event addEvent(Event event) {
        ...
        Event savedEvent = ejr.save(event);
    ...
    public Event updateEvent(int eventId, Event event) {
        ...
        try {
            Event newEvent = ejr.findById(eventId).get();
